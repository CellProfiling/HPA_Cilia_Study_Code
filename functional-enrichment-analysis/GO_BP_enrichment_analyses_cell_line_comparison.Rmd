...
```{r, dev = 'svg', fig.width=14, fig.height=35}
# plot dotplot
...
```{r, dev = 'svg', fig.width=15, fig.height=9}
grid.newpage()
grid.draw(heatmap_plot)
```
...
### Dot plot of uniquely enriched terms
```{r, dev = 'svg', fig.width=14, fig.height=13}
# plot dotplot
...
### Dot plot of uniquely enriched terms
```{r, dev = 'svg', fig.width=14, fig.height=4}
# plot dotplot
...
### Dot plot of uniquely enriched terms
```{r, dev = 'svg', fig.width=14, fig.height=5}
# plot dotplot
